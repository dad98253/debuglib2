...
bool SaveStringInHeap(char **lpHeapFile,char *str)
{
	...
	int istart;
	int iend;
//	dfprintf2(__LINE__,__FILE__,DEBUGSAVEINSTRING,"save \"%s\" *lpHeapFile=(0x%llx)\n",str,*lpHeapFile);
...
//	dfprintf2(__LINE__,__FILE__,DEBUGSAVEINSTRING,"save string at (0x%llx)+%i of length %i\n",*lpHeapFile,istart,(int)strlen(str));
